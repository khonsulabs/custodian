...
fn cipher_suites(criterion: &mut Criterion) {
	criterion.bench_function("Ristretto225 + SHA-512 + Argon2id", |bencher| {
		bencher.iter(|| cipher_suite(Group::Ristretto255, Hash::Sha2, Mhf::Argon2id).unwrap())
	});
	criterion.bench_function("Ristretto225 + SHA-512 + Argon2d", |bencher| {
		bencher.iter(|| cipher_suite(Group::Ristretto255, Hash::Sha2, Mhf::Argon2d).unwrap())
	});
	#[cfg(feature = "pbkdf2")]
	criterion.bench_function("Ristretto225 + SHA-512 + PBKDF2", |bencher| {
		bencher.iter(|| cipher_suite(Group::Ristretto255, Hash::Sha2, Mhf::Pbkdf2).unwrap())
	});
	#[cfg(feature = "sha3")]
	criterion.bench_function("Ristretto225 + SHA3-512 + Argon2id", |bencher| {
		bencher.iter(|| cipher_suite(Group::Ristretto255, Hash::Sha3, Mhf::Argon2id).unwrap())
	});
	#[cfg(feature = "sha3")]
	criterion.bench_function("Ristretto225 + SHA3-512 + Argon2d", |bencher| {
		bencher.iter(|| cipher_suite(Group::Ristretto255, Hash::Sha3, Mhf::Argon2d).unwrap())
	});
	#[cfg(all(feature = "sha3", feature = "pbkdf2"))]
	criterion.bench_function("Ristretto225 + SHA3-512 + PBKDF2", |bencher| {
		bencher.iter(|| cipher_suite(Group::Ristretto255, Hash::Sha3, Mhf::Pbkdf2).unwrap())
	});
	#[cfg(feature = "blake3")]
